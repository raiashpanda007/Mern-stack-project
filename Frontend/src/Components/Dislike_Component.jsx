...
function Dislike_Component({dislikesCount,isDisLiked = false, onClick}) {
  return (
    <div onClick={onClick} className=' w-1/4 flex items-start justify-evenly pt-1 pb-1 rounded-3xl border cursor-pointer'>
